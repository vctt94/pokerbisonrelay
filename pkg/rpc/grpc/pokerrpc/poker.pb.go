...
const file_poker_proto_rawDesc = "" +
	...
	"\btable_id\x18\x02 \x01(\tR\atableId\"\xdf\x03\n" +
	"\n" +
	"GameUpdate\x12\x19\n" +
	...
	"\tbest_hand\x18\x03 \x03(\v2\x0e.pokerrpc.CardR\bbestHand\"2\n" +
	"\x15GetLastWinnersRequest\x12\x19\n" +
	"\btable_id\x18\x01 \x01(\tR\atableId\"D\n" +
	"\x16GetLastWinnersResponse\x12*\n" +
	"\awinners\x18\x01 \x03(\v2\x10.pokerrpc.WinnerR\awinners\"\x9f\x01\n" +
	"\x06Winner\x12\x1b\n" +
	...
	"\fEvaluateHand\x12\x1d.pokerrpc.EvaluateHandRequest\x1a\x1e.pokerrpc.EvaluateHandResponse\"\x00\x12U\n" +
	"\x0eGetLastWinners\x12\x1f.pokerrpc.GetLastWinnersRequest\x1a .pokerrpc.GetLastWinnersResponse\"\x002\xb2\b\n" +
	"\fLobbyService\x12L\n" +
...
var file_poker_proto_goTypes = []any{
	...
	(*GetLastWinnersRequest)(nil),          // 17: pokerrpc.GetLastWinnersRequest
	(*GetLastWinnersResponse)(nil),         // 18: pokerrpc.GetLastWinnersResponse
...
var file_poker_proto_depIdxs = []int32{
	...
	19, // 7: pokerrpc.GetLastWinnersResponse.winners:type_name -> pokerrpc.Winner
	...
	17, // 26: pokerrpc.PokerService.GetLastWinners:input_type -> pokerrpc.GetLastWinnersRequest
	...
	18, // 47: pokerrpc.PokerService.GetLastWinners:output_type -> pokerrpc.GetLastWinnersResponse
